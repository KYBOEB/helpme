...
2. Система определяет проблему. Поиск по базе знаний выдаёт подходящую карточку с инструкциями для решения проблемы.

3. Выдаются шаги решения. На экране один шаг, под ним кнопки «Всё получилось»
...
Если система не может распознать текст, она направляет пользователя с помощью кнопок для выбора темы обращения.
